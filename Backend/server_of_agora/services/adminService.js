...
const AdminService = {
    createAdmin: async (adminData) => {
        return new Promise((resolve, reject) => {
            ...
            const sql = `INSERT INTO admin (username, password, email, app_id, app_certificate, channel_name, token_id, adminlimits, name) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)`;

            db.query(sql, [username, password, email, app_id, app_certificate, channel_name, token_id, adminlimits, name], (err, result) => {
                if (err) {
